 ...
 * https://github.com/r-devel/r-svn/blob/d0ea08d5f3cdc49a17a3d4fdae498876695326eb/src/library/stats/src/isoreg.c
 *
 * Only change: #include "modreg.h" (an internal stats header, not shipped with
 * R) is replaced by the two public headers it pulls in, so that the file builds
 * standalone with R CMD SHLIB.
 */
