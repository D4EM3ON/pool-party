...
package_names <- "old/stats-monotone-smacof"

# directlabels::isoreg_dp() only appeared in directlabels 2026.8.27
# so no testing here
isotonic_functions <- list(
  stats = function(x) isoreg_old(x)$yf,
  monotone = monotone::monotone,
  smacof = smacof:::pavasmacof
)
